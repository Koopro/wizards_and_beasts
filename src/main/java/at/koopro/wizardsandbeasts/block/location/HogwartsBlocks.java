...
public final class HogwartsBlocks {
    ...
    public static final VariantSet HOGWARTS_STONE =
            LocationBlockHelper.withVariants("hogwarts_stone", LocationBlockHelper.stone(MapColor.COLOR_GRAY));
    ...
    public static final VariantSet HOGWARTS_STONE_BRICKS =
            LocationBlockHelper.withVariants("hogwarts_stone_bricks", LocationBlockHelper.stone(MapColor.COLOR_GRAY));
    ...
    public static final BlockEntry HOGWARTS_CRACKED_STONE_BRICKS =
            LocationBlockHelper.block("hogwarts_cracked_stone_bricks", LocationBlockHelper.stone(MapColor.COLOR_GRAY));
    ...
    public static final VariantSet HOGWARTS_MOSSY_STONE_BRICKS =
            LocationBlockHelper.withVariants("hogwarts_mossy_stone_bricks", LocationBlockHelper.stone(MapColor.COLOR_GRAY));

    // ASSET: hogwarts_stone_pillar (side), hogwarts_stone_pillar_top (end)
    // Recipe (gated by Module.STRUCTURES, see ModRecipeProvider) —hogwarts_stone
    public static final PillarEntry HOGWARTS_STONE_PILLAR =
            LocationBlockHelper.pillar("hogwarts_stone_pillar", LocationBlockHelper.stone(MapColor.COLOR_GRAY));
    ...
    public static final VariantSet HOGWARTS_DARK_STONE =
            LocationBlockHelper.withVariants("hogwarts_dark_stone", LocationBlockHelper.stone(MapColor.DEEPSLATE));

    // ASSET: hogwarts_flagstone, hogwarts_flagstone_slab
    // Recipe (gated by Module.STRUCTURES, see ModRecipeProvider) —hogwarts_stone
    public static final SlabSet HOGWARTS_FLAGSTONE =
            LocationBlockHelper.withSlab("hogwarts_flagstone", LocationBlockHelper.stone(MapColor.COLOR_LIGHT_GRAY));
    ...
    public static final SlabSet HOGWARTS_FLOOR_TILE =
            LocationBlockHelper.withSlab("hogwarts_floor_tile", LocationBlockHelper.stone(MapColor.COLOR_LIGHT_GRAY));
    ...
    public static final BlockEntry ENCHANTED_CEILING_TILE =
            LocationBlockHelper.block("enchanted_ceiling_tile", LocationBlockHelper.stone(MapColor.COLOR_BLUE));
