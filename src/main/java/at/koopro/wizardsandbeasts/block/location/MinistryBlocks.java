...
public final class MinistryBlocks {
    ...
    public static final VariantSet MINISTRY_BLACK_MARBLE =
            LocationBlockHelper.withVariants("ministry_black_marble", LocationBlockHelper.stone(MapColor.COLOR_BLACK));
    ...
    public static final PillarEntry MINISTRY_BLACK_MARBLE_PILLAR =
            LocationBlockHelper.pillar("ministry_black_marble_pillar", LocationBlockHelper.stone(MapColor.COLOR_BLACK));
    ...
    public static final StairSet MINISTRY_BLACK_MARBLE_TILES =
            LocationBlockHelper.withSlabStair("ministry_black_marble_tiles", LocationBlockHelper.stone(MapColor.COLOR_BLACK));
    ...
    public static final VariantSet MINISTRY_GILDED_BLACK_MARBLE =
            LocationBlockHelper.withVariants("ministry_gilded_black_marble", LocationBlockHelper.stone(MapColor.COLOR_BLACK));
    ...
    public static final BlockEntry MINISTRY_GILDED_TRIM =
            LocationBlockHelper.block("ministry_gilded_trim", LocationBlockHelper.stone(MapColor.GOLD));
    ...
    public static final StairSet MINISTRY_DARK_TILE =
            LocationBlockHelper.withSlabStair("ministry_dark_tile", LocationBlockHelper.stone(MapColor.COLOR_GRAY));
    ...
    public static final SlabSet MINISTRY_FLOOR_TILE =
            LocationBlockHelper.withSlab("ministry_floor_tile", LocationBlockHelper.stone(MapColor.COLOR_LIGHT_GRAY));
    ...
    public static final BlockEntry MINISTRY_WALL_PANEL =
            LocationBlockHelper.block("ministry_wall_panel", LocationBlockHelper.stone(MapColor.COLOR_GRAY));
