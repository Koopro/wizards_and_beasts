...
public final class BestiaryScreen extends Screen {
    ...
    private Identifier resolveEntryPortrait(BestiaryEntry entry) {
    ...
    private void renderDetail(GuiGraphics gg, BestiaryEntry entry) {
        ...
        int portraitY = dy;
        int portraitSize = 32;
        drawStretched(gg, resolveEntryPortrait(entry), portraitX, portraitY, portraitSize, portraitSize, 32, 32);
