...
public final class HeritageCommands {
    ...
    public static LiteralArgumentBuilder<CommandSourceStack> register(String literal) {
        ...
        if ("wiztype".equals(literal)) {
            root.executes(ctx -> {
                ctx.getSource().sendSuccess(() -> Component.literal(
                        "The /wandb wiztype command is deprecated. Use /wandb type instead.")
    ...
    private static int set(CommandSourceStack source, ServerPlayer target,
        ...
        HeritageDataSyncS2CPacket.syncToPlayer(target, false);
    ...
    private static int reset(CommandSourceStack source, ServerPlayer target) {
        ...
        HeritageDataSyncS2CPacket.syncToPlayer(target, true);
