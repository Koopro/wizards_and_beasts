...
import at.koopro.wizardsandbeasts.ability.apparition.ApparitionWard;
import at.koopro.wizardsandbeasts.ability.apparition.ApparitionWardRegistry;
...
public final class ApparitionCommands {
    ...
    private static int addWard(CommandContext<CommandSourceStack> context, String idValue, String customMessage) {
        ...
        source.sendSuccess(() -> Component.literal("Added Apparition ward " + id), true);
        return 1;
    }
    ...
    private static int removeWard(CommandSourceStack source, String idValue) {
        ...
        ApparitionWardRegistry.save(source.getServer());
        ApparitionWardsSyncS2CPayload.syncToAllPlayers(source.getServer());
        source.sendSuccess(() -> Component.literal("Removed Apparition ward " + id), true);
        return 1;
    }
    ...
    private static int passTest(CommandSourceStack source, ServerPlayer player) {
        ...
        player.displayClientMessage(Component.literal("Congratulations — you have passed your Apparition test. You are now licensed to Apparate."), false);
        source.sendSuccess(() -> Component.literal("Licensed " + player.getName().getString() + " for Apparition."), true);
        return 1;
    }
}
