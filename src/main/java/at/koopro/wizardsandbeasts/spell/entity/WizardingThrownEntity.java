package at.koopro.wizardsandbeasts.spell.entity;
...
public class WizardingThrownEntity extends ThrowableItemProjectile {
    ...
    private WizardingThrownKind kindFromStack() {
        ...
        if (item == ModItems.ERUMPENT_HORN.get()) {
            return WizardingThrownKind.ERUMPENT_HORN;
        }
        if (item == ModItems.DECOY_DETONATOR.get()) {
    ...
    protected Item getDefaultItem() {
        return ModItems.ERUMPENT_HORN.get();
    }
