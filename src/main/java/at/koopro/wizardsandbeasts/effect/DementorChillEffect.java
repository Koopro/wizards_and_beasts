...
public final class DementorChillEffect extends MobEffect {
    ...
    public boolean applyEffectTick(@NonNull ServerLevel level, @NonNull LivingEntity entity, int amplifier) {
        entity.addEffect(new MobEffectInstance(MobEffects.SLOWNESS, 30, 0, false, true, true));
        entity.addEffect(new MobEffectInstance(MobEffects.DARKNESS, 30, 0, false, true, true));
        return true;
    }
