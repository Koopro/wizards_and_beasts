...
public final class ObscuroEffect extends MobEffect {
    public ObscuroEffect() {
        super(MobEffectCategory.HARMFUL, 0x6A0DAD);
    }

    @Override
    public boolean applyEffectTick(@NonNull ServerLevel level, @NonNull LivingEntity entity, int amplifier) {
        entity.addEffect(new MobEffectInstance(MobEffects.BLINDNESS, 25, 0, false, false, false));
