...
/**
 * A magical people: who a character is born among, what their body is, and how their magic comes to them.
 *
 * <p>Not a character class. A heritage carries <b>no</b> flat bonus for being what it is — Wizardkind, the baseline,
 * carries nothing at all. The only numbers here describe bodies canon describes as physically different: a giant's
 * size and hide, a centaur's frame, the small stature of goblins and house-elves. Everything else a heritage means is
 * a trait with a name ({@link HeritageTraits}), shown to the player in words.
 *
 * <p>Lycanthropy and the Obscurus are not heritages: they happen to a witch or wizard. See {@link MagicalCondition}.
 */
public enum Heritage {
    ...
    GOBLIN("goblin", "Goblin",
            ...
            false, MagicSource.INNATE, -2, 0, 0, SizeCategory.SMALL, 0xFF887744, false),
    ...
    HOUSE_ELF("house_elf", "House-Elf",
            ...
            false, MagicSource.INNATE, -4, 0, 0, SizeCategory.SMALL, 0xFF88AACC, false),
    ...
    VEELA("veela", "Veela",
            ...
            true, MagicSource.HYBRID, 0, 0, 0, SizeCategory.NORMAL, 0xFFFFCCEE, false),
    ...
    CENTAUR("centaur", "Centaur",
            ...
            false, MagicSource.INNATE, 6, 0.03, 0, SizeCategory.LARGE, 0xFF886633, false),
    ...
    VAMPIRE("vampire", "Vampire",
            ...
            true, MagicSource.HYBRID, 0, 0, 0, SizeCategory.NORMAL, 0xFF330055, false),
    ...
    MERPEOPLE("merpeople", "Merpeople",
            ...
            false, MagicSource.INNATE, 0, 0, 0, SizeCategory.NORMAL, 0xFF2288AA, false);
