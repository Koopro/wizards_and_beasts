package at.koopro.wizardsandbeasts.wand.client;

import at.koopro.wizardsandbeasts.spell.client.gui.ImperioCommandScreen;
...
/**
 * Client-only wand release hooks (keeps {@link at.koopro.wizardsandbeasts.wand.item.WandItem} free of client imports).
 */
