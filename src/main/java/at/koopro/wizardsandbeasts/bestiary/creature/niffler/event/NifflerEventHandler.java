package at.koopro.wizardsandbeasts.bestiary.creature.niffler.event;
...
public final class NifflerEventHandler {
    ...
    public static void onNifflerJoinLevel(EntityJoinLevelEvent event) {
        ...
        for (int i = 0; i < count; i++) {
            at.koopro.wizardsandbeasts.bestiary.creature.niffler.BabyNifflerEntity baby =
                    new at.koopro.wizardsandbeasts.bestiary.creature.niffler.BabyNifflerEntity(
