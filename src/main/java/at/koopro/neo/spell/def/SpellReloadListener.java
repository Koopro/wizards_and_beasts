...
import at.koopro.neo.spell.JsonSpell;
...
/**
 * Loads {@link SpellDefinition}s from {@code data/<namespace>/neo/spells/*.json}
...
public class SpellReloadListener extends SimpleJsonResourceReloadListener<SpellDefinition> {
    ...
    public static final String DIRECTORY = "neo/spells";
