...
public class FamousWizardCardItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay display,
        ...
        if (id != null) {
            tooltipAdder.accept(Component.translatable("item.neo.famous_wizard_card.variant." + id)
                    .withStyle(ChatFormatting.GRAY));
        } else {
            tooltipAdder.accept(Component.translatable("item.neo.famous_wizard_card.blank").withStyle(ChatFormatting.DARK_GRAY));
        }
    }
}
