...
import at.koopro.neo.brew.BrewingRecipe;
import at.koopro.neo.brew.BrewingRecipes;
 ...
 * {@code data/<ns>/neo/brewing_recipes/*.json} on every datapack reload.
 *
...
public class BrewingRecipeReloadListener extends SimpleJsonResourceReloadListener<BrewingRecipeDefinition> {
    ...
    public static final String DIRECTORY = "neo/brewing_recipes";
