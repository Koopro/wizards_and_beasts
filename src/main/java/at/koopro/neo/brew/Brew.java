 ...
 * its own. Created from a {@link at.koopro.neo.brew.def.BrewDefinition} during
 * datapack reload (or registered programmatically by addon mods).
 *
 * <p>Mirrors the {@link at.koopro.neo.spell.Spell} hierarchy intentionally:
 ...
 *
 * @param id          fully-qualified id (e.g. {@code "neo:wiggenweld_potion"})
