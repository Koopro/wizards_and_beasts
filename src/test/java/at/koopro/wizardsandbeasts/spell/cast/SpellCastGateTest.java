...
class SpellCastGateTest {
    ...
    private static Inputs allClear() {
        return new Inputs(true, true, true, true, false, true, false, false, false, false);
    }
    ...
    void eachGateFiresAtItsPosition() {
        assertEquals(SpellCastGate.NO_ACTIVE_SPELL,
                SpellCastGate.evaluate(new Inputs(false, false, true, false, false, true, false, false, false, false)));
        assertEquals(SpellCastGate.UNKNOWN_SPELL,
                SpellCastGate.evaluate(new Inputs(true, false, true, false, false, true, false, false, false, false)));
        assertEquals(SpellCastGate.SPELL_NOT_IMPLEMENTED,
                SpellCastGate.evaluate(new Inputs(true, true, false, false, false, true, false, false, false, false)));
        assertEquals(SpellCastGate.SPELL_NOT_KNOWN,
                SpellCastGate.evaluate(new Inputs(true, true, true, false, false, true, false, false, false, false)));
        assertEquals(SpellCastGate.OBSCURIAL_ABILITY_INPUT,
                SpellCastGate.evaluate(new Inputs(true, true, true, true, true, true, false, false, false, false)));
        assertEquals(SpellCastGate.REQUIREMENTS_UNMET,
                SpellCastGate.evaluate(new Inputs(true, true, true, true, false, false, false, false, false, false)));
        assertEquals(SpellCastGate.OBSCURIAL_DARK_ONLY,
                SpellCastGate.evaluate(new Inputs(true, true, true, true, false, true, true, false, false, false)));
        assertEquals(SpellCastGate.OBSCURIAL_DARK_RESTRICTED,
                SpellCastGate.evaluate(new Inputs(true, true, true, true, false, true, false, true, false, false)));
        assertEquals(SpellCastGate.ON_COOLDOWN,
                SpellCastGate.evaluate(new Inputs(true, true, true, true, false, true, false, false, true, false)));
        assertEquals(SpellCastGate.GLOBAL_COOLDOWN,
                SpellCastGate.evaluate(new Inputs(true, true, true, true, false, true, false, false, false, true)));
    }
    ...
    void precedence_earlierGateWins() {
        ...
        assertEquals(SpellCastGate.SPELL_NOT_KNOWN,
                SpellCastGate.evaluate(new Inputs(true, true, true, false, false, true, false, false, true, true)));
        // Unresolved id AND unmet requirement -> UNKNOWN_SPELL wins.
        assertEquals(SpellCastGate.UNKNOWN_SPELL,
                SpellCastGate.evaluate(new Inputs(true, false, true, false, false, false, false, false, false, false)));
        // Own cooldown AND global cooldown -> ON_COOLDOWN wins.
        assertEquals(SpellCastGate.ON_COOLDOWN,
                SpellCastGate.evaluate(new Inputs(true, true, true, true, false, true, false, false, true, true)));
        ...
        assertEquals(SpellCastGate.UNKNOWN_SPELL,
                SpellCastGate.evaluate(new Inputs(true, false, false, false, false, true, false, false, false, false)));
    }
}
